...
if( NOT DEFINED ECBUILD_FILE_LOG_LEVEL )
  set(ECBUILD_FILE_LOG_LEVEL ${ECBUILD_DEBUG})
elseif( NOT ECBUILD_FILE_LOG_LEVEL )
  set(ECBUILD_FILE_LOG_LEVEL 60)
elseif( ECBUILD_FILE_LOG_LEVEL STREQUAL "DEBUG" )
  set(ECBUILD_FILE_LOG_LEVEL ${ECBUILD_DEBUG})
elseif( ECBUILD_FILE_LOG_LEVEL STREQUAL "INFO" )
  set(ECBUILD_FILE_LOG_LEVEL ${ECBUILD_INFO})
elseif( ECBUILD_FILE_LOG_LEVEL STREQUAL "WARN" )
  set(ECBUILD_FILE_LOG_LEVEL ${ECBUILD_WARN})
elseif( ECBUILD_FILE_LOG_LEVEL STREQUAL "ERROR" )
  set(ECBUILD_FILE_LOG_LEVEL ${ECBUILD_ERROR})
elseif( ECBUILD_FILE_LOG_LEVEL STREQUAL "CRITICAL" )
  set(ECBUILD_FILE_LOG_LEVEL ${ECBUILD_CRITICAL})
else()
  message(WARNING "Unknown file log level ${ECBUILD_FILE_LOG_LEVEL} (valid are DEBUG, INFO, WARN, ERROR, CRITICAL) - using DEBUG")
  set(ECBUILD_FILE_LOG_LEVEL ${ECBUILD_DEBUG})
endif()

if( NOT DEFINED ECBUILD_FILE_LOG )
  set( ECBUILD_FILE_LOG ${CMAKE_BINARY_DIR}/ecbuild.log )
endif()
...
function( ecbuild_log LEVEL )
  ...
  file( APPEND ${ECBUILD_FILE_LOG} "${_time} - ${PROJECT_NAME} - ${LEVEL} - ${MSG}\n" )
...
function( ecbuild_debug )
  ...
  if( ECBUILD_FILE_LOG_LEVEL LESS 11)
...
function( ecbuild_info )
  string( REPLACE ";" " " MSG "${ARGV}" )
  if( ECBUILD_FILE_LOG_LEVEL LESS 21)
...
function( ecbuild_warn )
  string( REPLACE ";" " " MSG "${ARGV}" )
  if( ECBUILD_FILE_LOG_LEVEL LESS 31)
...
function( ecbuild_error )
  string( REPLACE ";" " " MSG "${ARGV}" )
  if( ECBUILD_FILE_LOG_LEVEL LESS 41)
...
function( ecbuild_critical )
  string(REPLACE ";" " " MSG ${ARGV})
  if( ECBUILD_FILE_LOG_LEVEL LESS 51)
